...
@Schema(description = "Данные группы пользователей и действий с разрешениями")
public record MenuItemGroupPermissionsDto(
    @Schema(description = "ID группы", example = "019b4f74-58e2-7185-9a4b-b82619f12503",
