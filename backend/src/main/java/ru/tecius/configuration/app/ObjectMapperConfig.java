package ru.tecius.configuration.app;

import static com.fasterxml.jackson.databind.DeserializationFeature.ADJUST_DATES_TO_CONTEXT_TIME_ZONE;
import static com.fasterxml.jackson.databind.DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES;
import static com.fasterxml.jackson.databind.DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS;
import static java.time.format.DateTimeFormatter.ofPattern;
import static ru.tecius.util.Constants.BIRTHDAY_DATE_FORMAT;
import static ru.tecius.util.Constants.ISO_DATE_FORMAT;
import static ru.tecius.util.Constants.LOCAL_DATE_TIME_FORMAT;
